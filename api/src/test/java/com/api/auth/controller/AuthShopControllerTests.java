...
public class AuthShopControllerTests {
    ...
    public void setUp() {
        ...
        // Delete new shop
        if (shopRepository.existsByName(usernameNewShop)) {
            shopRepository.deleteByName(usernameNewShop);
        }
    }
    ...
    @Test
    public void testRegisterShop() throws JSONException {
        // Request
        ResponseEntity response = restTemplate.postForEntity(
        ...
        // Request to check if Shop is correctly registered withotu ebing whitelisted
