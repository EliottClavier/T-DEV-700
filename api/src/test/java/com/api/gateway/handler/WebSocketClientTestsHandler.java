...
public class WebSocketClientTestsHandler implements StompSessionHandler {
    protected final AtomicReference<MessageClient> messageClient = new AtomicReference<>();
    protected final AtomicReference<String> sessionId = new AtomicReference<>();
    protected final DestinationGenerator destinationGenerator = new DestinationGenerator();
